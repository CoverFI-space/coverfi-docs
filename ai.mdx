...
The app stores a one-time draft locally and pre-fills the Protect page with amount, asset, duration, and trigger price. The user must still review the fee, live price, trigger, and wallet prompt before signing.
