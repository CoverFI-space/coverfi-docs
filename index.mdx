...
The project is open source and split into a public website, authenticated app, backend API, protocol monitor, and Soroban contract workspace.
...
CoverFi protection is not insurance and does not guarantee a payout.
